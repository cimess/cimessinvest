...
import { ShieldCheck, LogOut, ArrowLeft, Terminal } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0F0F0F] text-[#F5F0EB] flex flex-col font-sans selection:bg-[#C9A96E] selection:text-black">
      ...
      <header className="h-16 border-b border-[#C9A96E]/20 bg-[#141414] px-6 sm:px-10 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Link
            href="/login"
            className="text-xs uppercase tracking-wider text-[#D9534F] hover:text-[#ff7875] transition-colors flex items-center space-x-1.5 px-3 py-1.5 rounded border border-white/5 hover:border-[#D9534F]/30"
          >
